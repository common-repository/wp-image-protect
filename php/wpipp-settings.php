...
class wpipp_settings {
    ...
    */
    function wpipp_watermarks_not_set_warning(){
          ...
          if(array_key_exists('ignore-wpipp-watermarks-not-set-warning', $_GET) && isset($_GET['ignore-wpipp-watermarks-not-set-warning'])){
    ...
    */
    function ignore_wpipp_watermarks_not_set_warning() {
        $ignore_wpipp_watermarks_not_set = array_key_exists('ignore-wpipp-watermarks-not-set-warning', $_GET) ? $_GET['ignore-wpipp-watermarks-not-set-warning'] : false;
    ...
    */
    ...
    function wpipp_options_enqueue_scripts() {  
        ...
        wp_localize_script( 'wpipp-script', 'framework', array('currentlyHidden'=>__("Currently Hidden - Click to show settings", 'wpipp'), 'hideSettings'=>__("Click to hide settings", 'wpipp'),  'areYouSure'=>__("Are you sure you wish to edit these settings?", 'wpipp') ) ); 
    ...
    function plugin_initialize_options_array(){
          ...
          if(class_exists('wpipp_font_manager')){
            try{
              ...
              //font manager cannot be loaded
              add_action( 'admin_notices', array($this, 'font_manager_incompatible') );
            }
    ...
    */
    function wpipp_uploaded_watermark_preview($value = NULL) {  
      ...
      */
      ...
      $settings_updated = array_key_exists('settings-updated', $_GET) ? $_GET['settings-updated'] : false;
    ...
    */
    ...
    /**
    * display error if font manager fails
    */

    function font_manager_incompatible(){
      ?>
        <div class="updated fade">
            <p><?php _e( 'Font manager cannot load, limited selection of fonts will be available if text watermark used.', 'wpipp' ); ?></p>
        </div>
        <?php
    }
