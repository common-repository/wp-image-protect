...
Contributors: 8MediaCentral
Donate link: http://8mediacentral.com/developments/wp-image-protect/donate/
Tags: watermark, watermarking, image, images, photo, photos, picture, pictures, content, dynamic,  wpipp, wp image protect, hotlink, hotlinking,
...
<a href="http://8mediacentral.com/developments/wp-image-protect-watermark-wordpress-images-plugin/">Add the WP Image Protect Premium Pack</a> for even more powerful features such as:
...
[youtube http://www.youtube.com/watch?v=ElAJo-ojvIc]

Some of the features included in the premium pack:

[youtube http://www.youtube.com/watch?v=sZcToOC96CE]
...
1. An overview of WP Image Protect.
2. The settings page for WP Image Protect Lite.
3. A preview of the settings available in WP Image Protect Premium.
4. The WP Image Protect family.
5. The new media statistics for images
...
= 2.4 =
* Backend user interface improvements

= 2.3 =
* Additional debug options, passes debug true options for WP 3.6

= 2.2 =
* Additional checks for permalinks settings

= 2.1 =
* Additional debugging options

= 2.0 =
* This version is required to use the new WP Image Protect Premium pack

= 1.8 =
* Now compatible with a number of plugins (do not upgrade on WordPress installations < 3.4)

= 1.7 =
* Users that had issues with contact-form-7 or WordPress SEO conflicts may wish to upgrade now.

= 1.6 =
* Watermark scaling added, support for jpeg files.

= 1.5 =
* Users that had issues with contact-form-7 conflicts may wish to upgrade now.

= 1.4 =
* Users that could not install due to GD compatibility issues will now be able to over-ride installation check and images can be manually excluded.

= 1.3 =
* Some image exclusion bugs have been fixed. Various options now available for modification of rewrite rules to address issues on some installations.

= 1.2 =
* Users experiencing performance issues will notice improvements with this release.

= 1.1 =
* Fixed issue with alpha transparency when loading transparent image and minor usability improvements.
