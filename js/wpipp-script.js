/**
*   Copyright 2014 8MediaCentral, All Rights Reserved
*
...
function show_wpipp_advanced_settings_rows(){
	if(confirm(framework.areYouSure)){
...
function add_show_wpipp_settings_link(){
	jQuery('#show_advanced_wpipp_settings_container').html("(<a href = '#' title = 'show advanced settings' onclick = 'show_wpipp_advanced_settings_rows(); return false;'>"+framework.currentlyHidden+"</a>)");	
}

function add_hide_wpipp_settings_link(){
	jQuery('#show_advanced_wpipp_settings_container').html("(<a href = '#' title = 'show advanced settings' onclick = 'hide_wpipp_advanced_settings_rows(); return false;'>"+framework.hideSettings+"</a>)");	
}
